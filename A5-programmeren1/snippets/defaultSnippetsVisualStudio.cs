...
//                        //namespace --> Creates a namespace declaration. location: Inside a namespace (including the global namespace).
//                        namespace MyNamespace
//                        {

//                        }

//    //prop --> 	Creates an auto-implemented property declaration. location: 	Inside a class or a struct.
//    public int MyProperty { get; set; }

//    //ropfull --> Creates a property declaration with get and set accessors. location: Inside a class or a struct.
//    //propg --> Creates a read-only auto-implemented property with a private "set" accessor. location: Inside a class or a struct.
//    public int MyProperty { get; private set; }

//            //sim --> Creates a staticint Main method declaration. location: Inside a class or a struct.
...
//            //struct --> Creates a struct declaration. location: Inside a namespace (including the global namespace), a class, or a struct.
//            struct MyStruct
//            {

//            }

//            //svm --> Creates a staticvoid Main method declaration. location: Inside a class or a struct.
//            static void Main(string[] args)
//            {

//            }

//            //switch --> Creates a switch block. location: Inside a method, an indexer, a property accessor, or an event accessor.
//            switch (switch_on)
//	        {
//		        default:
//	        }

//            //try --> Creates a try-catch block. location: Inside a method, an indexer, a property accessor, or an event accessor.
//            try 
//	        {	        
...
//            //tryf --> Creates a try-finally block. location: Inside a method, an indexer, a property accessor, or an event accessor.
//            try 
//	        {	        
...
//            //unchecked --> Creates an unchecked block. location: 	Inside a method, an indexer, a property accessor, or an event accessor.
//            unchecked
//	        {
            
//	        }

//            //unsafe --> Creates an unsafe block. location: Inside a method, an indexer, a property accessor, or an event accessor.
//            unsafe
//	        {
            
//	        }

//            //using --> Creates a using directive. location: Inside a namespace (including the global namespace).
//            using(resource)
//	        {

//	        }

//            //while --> 	Creates a while loop. location: Inside a method, an indexer, a property accessor, or an event accessor.
//            while (true)
//	        {
